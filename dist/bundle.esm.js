import { mak, useMakUi, componentWrapperLogic } from '@mak-stack/mak-ui';
import React$1, { useContext, useRef, useEffect, createContext } from 'react';
...
const BackDrop = ({
  ...
  return /*#__PURE__*/React$1.createElement(mak.div, {
    key: "blur",
    onClick: onClose,
...
const ComponentWrapper = _a => {
  ...
  return /*#__PURE__*/React$1.createElement(React$1.Fragment, null, typeof children === "function" ? children(Object.assign(Object.assign({}, response), props)) : children);
};
...
const Modal = ({
  ...
  const [showButton, setShowButton] = React$1.useState(true);
  ...
  }, /*#__PURE__*/React$1.createElement(AnimatePresence, null, isOpen && /*#__PURE__*/React$1.createElement("div", {
    className: "absolute left-0 top-0 z-50 flex h-screen w-screen items-center justify-center"
  }, /*#__PURE__*/React$1.createElement(mak.div, {
  ...
  }, children), /*#__PURE__*/React$1.createElement(ModalBackDrop, {
    onClose: onClose,
...
export { BackDrop, Button, Modal, ModalContent, ModalFooter, ModalHeader };
